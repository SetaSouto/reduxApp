    ...
    switch (action.type) {
        ...
        case 'DELETE_BOOK':
            ...
            if (indexToDelete !== -1) {
                ...
                _newState.books = [].concat(_toConsumableArray(books.slice(0, indexToDelete)), _toConsumableArray(books.slice(indexToDelete + 1)));
                return _newState;
            } else {
                return state;
            }
        ...
        case 'UPDATE_BOOK':
            ...
            var bookUpdated = _extends({}, state.books[indexToUpdate], { title: action.payload.title });
            var newState = _extends({}, state);
            newState.books = [].concat(_toConsumableArray(state.books.slice(0, indexToUpdate)), [bookUpdated], _toConsumableArray(state.books.slice(indexToUpdate + 1)));
            return newState;
    }
    return state;
}
